...
//   if (currentGame.players.length === 3 && boardScreen === true) {
...
$(document).ready(function(){
  ...
  $("#joinSession-button").click(function(){
    ...
    if ( !("players" in currentGame[sessionEnter]) || Object.keys(currentGame[sessionEnter].players).length < 3) {
      //add player
      database.ref().child(sessionEnter + "/players").push({
        username: userName,
        choice: "",
        avatar: "",
      });
      ...
      // STORE userArrayKey generated by Firebase to be able to reference it when choosing player avatar
  ...
  $(".avatar-option").click(function() {
    ...
    var avatarName = $(this).attr("data-name");

    // This piece of code doesn't work
    database.ref().child(localStorage.getItem("sessionCode") + "/players").orderByChild("username").equalTo(avatarName).update({
      avatar: avatarImg
    });
